...
class SystemUserList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('AppFormUsers', 'onEdit'), ['register_state' => 'false'] );
        ...
        $panel->addHeaderActionLink('', new TAction(['AppFormUsers', 'onEdit'], ['register_state' => 'false']), 'fa:plus');
